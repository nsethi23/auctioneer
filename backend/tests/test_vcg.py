...
def test_run_vcg_auction_reserve_filters_out_low_bidders():
    bidders = [
        {"id": "A", "value": 10.0, "bid": 10.0},
    ...
    result = run_vcg_auction(bidders, [0.6, 0.3], reserve_price=6.0)

    assert len(result["allocations"]) == 1
    assert result["allocations"][0]["bidder_id"] == "A"


def test_run_vcg_auction_single_eligible_winner_pays_reserve():
    bidders = [
        {"id": "A", "value": 10.0, "bid": 10.0},
        {"id": "B", "value": 8.0, "bid": 5.0},
    ]
...
def test_run_vcg_auction_reserve_sets_minimum_price_with_multiple_winners():
    bidders = [
        {"id": "A", "value": 10.0, "bid": 10.0},
        {"id": "B", "value": 8.0, "bid": 8.0},
    ]
...
def test_run_vcg_auction_reserve_can_leave_all_slots_unfilled():
    bidders = [
...
def test_run_vcg_auction_default_reserve_keeps_original_behavior():
    bidders = [
        {"id": "A", "value": 10.0, "bid": 10.0},
        {"id": "B", "value": 8.0, "bid": 8.0},
        {"id": "C", "value": 5.0, "bid": 5.0},
